...
function generateUrlEntry($loc, $lastmod, $changefreq, $priority, $imageUrl = null, $videoFile = null) {
    ...
    if ($imageUrl) {
        ...
        $xml .= "            <image:title>FilesWith</image:title>\n";
        $xml .= "        </image:image>\n";
    }
    ...
    if ($videoFile) {
        ...
        $xml .= "            <video:description>Download " . htmlspecialchars($videoFile['file_name']) . " via FilesWith</video:description>\n";
        $xml .= "            <video:content_loc>" . htmlspecialchars($loc) . "/download</video:content_loc>\n";
        $xml .= "            <video:thumbnail_loc>https://fileswith.com/icon.png</video:thumbnail_loc>\n";
        $xml .= "        </video:video>\n";
    }
