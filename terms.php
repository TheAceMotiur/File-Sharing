...
<head>
    ...
    <title>Terms of Service - FreeNetly</title>
    ...
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 space-y-6">
            <section>
                ...
                <p class="text-gray-600">By accessing and using FreeNetly, you accept and agree to be bound by the terms and provision of this agreement.</p>
            </section>
            ...
            <section>
                ...
                <p class="text-gray-600">Your use of FreeNetly is also governed by our <a href="privacy" class="text-blue-600 hover:underline">Privacy Policy</a>.</p>
            </section>
