...
<div 
    ...
    <div class="flex items-center justify-between h-16 bg-gray-900 px-4">
        <a href="/dashboard" class="text-white text-xl font-bold"><?php echo getSiteName(); ?> Admin</a>
        <!-- Mobile Close Button -->
    ...
    <nav class="mt-6">
        ...
        <div class="space-y-2 px-4">
            ...
            <!-- Backup & Restore -->
            <a href="backup.php" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 rounded-lg transition-colors <?php echo basename($_SERVER['PHP_SELF']) === 'backup.php' ? 'bg-gray-700' : ''; ?>">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
