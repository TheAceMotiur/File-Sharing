...
<div 
    ...
    <nav class="mt-6">
        ...
        <div class="space-y-2 px-4">
            ...
            <!-- Cron Jobs -->
            <a href="cron.php" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 rounded-lg transition-colors <?php echo basename($_SERVER['PHP_SELF']) === 'cron.php' ? 'bg-gray-700' : ''; ?>">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
