...
<body class="bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <section class="mb-8">
                ...
                <pre><code class="language-bash">curl -H "X-Api-Key: YOUR_API_KEY" https://fileswith.com/api.php</code></pre>
            </section>
            ...
            <section class="mb-8">
                ...
                <pre><code class="language-bash">curl -H "X-Api-Key: YOUR_API_KEY" https://fileswith.com/api.php?action=list</code></pre>
    ...
    "data": {
        "files": [
            ...
            <section class="mb-8">
                ...
                <h3 class="text-lg font-semibold mt-4 mb-2">Example Request</h3>
                <pre><code class="language-bash">curl -X POST https://fileswith.com/api.php?action=upload \
    ...
    "data": {
        "file_id": "abc123",
        "download_url": "https://fileswith.com/download/abc123"
    }
}</code></pre>
